...
//    private static final Specialist second_specialist = new Specialist( "Anthony", "Joshua", Province.DOLNOSLASKIE, "Katowice", secondProfessionSet, "503942034");
...
////        assertThat(specialistRepo.findSpecialistById(2L)).isNotEqualTo(second_specialist.getSpecialistId());
////    }
//
//    @Test
